...
import bImg1 from '../../images/hero/contact image.png'
...
const TeamPage = (props) => {
    ...
    return (
        <Fragment>
            <div className='body_wrap sco_agency pb-85'>
                <Header3 />
                            ...
                            <div className="row mt-none-30 align-items-end">
                                <div className="col-lg-9 mt-30">
                                    <div className="page-title-box">
                                        ...
                                        <h2 className="title">Connect Today for Smarter Engineering Solutions</h2>
                                    </div>
                                </div>
