...
import MepEngineering from '../ServiceSinglePage/MepEngineering';
import ValueEngineeringSolutions from '../ServiceSinglePage/ValueEngineeringSolutions';
import ThirdPartyReviews from '../ServiceSinglePage/ThirdPartyReviews';
import BimSolutions from '../ServiceSinglePage/BimSolutions';
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="service/MEP-design-engineering" element={<MepEngineering />} />
          <Route path="service/Value-engineering-solutions" element={<ValueEngineeringSolutions />} />
          <Route path="service/Third-party-reviews" element={<ThirdPartyReviews />} />
          <Route path="service/BIM-solutions" element={<BimSolutions />} />
