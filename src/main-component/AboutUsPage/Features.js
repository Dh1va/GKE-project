                ...
                <div className="ap-feature_wrap">
                    <div className="row mt-none-30">
                        <div className="col-lg-3 col-md-6 mt-30 ">
                            <div className="ap-feature-item wow fadeInUp mx-auto-sm" data-wow-delay="0ms" data-wow-duration="600ms">
                        ...
                        <div className="col-lg-3 col-md-6 mt-30">
                            <div className="ap-feature-item wow fadeInUp mx-auto-sm" data-wow-delay="100ms" data-wow-duration="600ms">
                        ...
                        <div className="col-lg-3 col-md-6 mt-30">
                            <div className="ap-feature-item wow fadeInUp mx-auto-sm" data-wow-delay="200ms" data-wow-duration="600ms">
                        ...
                        <div className="col-lg-3 col-md-6 mt-30 ">
                            <div className="ap-feature-item wow fadeInUp mx-auto-sm" data-wow-delay="300ms" data-wow-duration="600ms">
