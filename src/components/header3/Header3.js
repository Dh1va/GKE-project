...
import logo2 from '../../images/logo/GKE logo v5 mobile.png'
...
import mImg from '../../images/casestudy/Dropdown img.png'
                            ...
                            <div className="main-menu__wrap ul_li navbar navbar-expand-xl">
                                <nav className="main-menu collapse navbar-collapse">
                                    <ul>
                                        ...
                                        <li className="menu-item-has-children megamenu">
                                            <Link onClick={ClickHandler} to="/"><span>Services</span></Link>
                                            <ul className="submenu">
                                                <li>
                                                    <div className="mega_menu_wrapper">
                                                        <div className="container">
                                                                ...
                                                                <div className="row justify-content-lg-between">
                                                                                        ...
                                                                                        <ul
                                                                                            ...
                                                                                            <li>
                                                                                                <Link onClick={ClickHandler}
                                                                                                    to="/service/MEP-design-engineering">
                                                                                                    <span
                                                                                                        className="icon_list_text">MEP Design Engineering</span>
                                                                                                </Link>
                                                                                            </li>
                                                                                            <li>
                                                                                                <Link onClick={ClickHandler}
                                                                                                    to="/service/Value-engineering-solutions">
                                                                                                    <span
                                                                                                        className="icon_list_text">Value Engineering Solutions</span>
                                                                                                </Link>
                                                                                            </li>
                                                                                            {/* <li>
                                                                                                <Link onClick={ClickHandler}
                                                                                                    to="/service-single/Niche-research">
                                                                                                    <span
                                                                                                        className="icon_list_text">Third-Party Reviews</span>
                                                                                                </Link>
                                                                                            </li>
                                                                                            <li>
                                                                                                <Link onClick={ClickHandler}
                                                                                                    to="/service-single/Niche-research">
                                                                                                    <span
                                                                                                        className="icon_list_text">BIM Solutions (LOD 100–500)</span>
                                                                                                </Link>
                                                                                            </li> */}
                                                                                        </ul>
                                                                                    </div>
                                                                                ...
                                                                                <div className="col-xl-6">
                                                                                    <div className="megamenu_widget">
                                                                                        <ul
                                                                                            ...
                                                                                            <li>
                                                                                                <Link onClick={ClickHandler}
                                                                                                    to="/service/Third-party-reviews">
                                                                                                    <span
                                                                                                        className="icon_list_text">Third-Party Reviews</span>
                                                                                                </Link>
                                                                                            </li>
                                                                    ...
                                                                    <div className="col-xl-3">
                                                                        <div className="megamenu_case">
                                                                            <h3>Blog</h3>
                                                                            <h4>How Engineering ...</h4>
                                                                            <img src={mImg} alt="" />
                                                                            <Link onClick={ClickHandler} className="megamenu_btn" to="/blog-single/How-Engineering-and-BIM-Solutions-Improve-Project-Efficiency">
                                                                                <span className="btn_label">View Blog</span>
