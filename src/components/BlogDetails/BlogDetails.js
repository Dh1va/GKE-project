        ...
        <section className="blog_details_section pt-70">
            <div className="container">
                <div className="item-details_image pos-rel mb-80">
                    <img src={BlogDetails.banner} alt="" />
                </div>
                ...
                <div className="row mt-none-30 g-0 align-items-start">
                    <div className="col-lg-8 mt-30">
                        <div className="blog_details_content">
                            ...
                            <h3 className="item_details_info_heading">{BlogDetails.subtitle2}</h3>
                            <p>{BlogDetails.subtext2}</p>
                            <h3 className="item_details_info_heading">{BlogDetails.subtitle3}</h3>
                            <p>{BlogDetails.subtext3}</p>
                             <h3 className="item_details_info_heading">{BlogDetails.subtitle4}</h3>
                            <p>{BlogDetails.subtext4}</p>
                            ...
                            <h3 className="item_details_info_heading">{BlogDetails.conclusion}</h3>
                            <p>
                               {BlogDetails.conclusionText}
                            </p>
