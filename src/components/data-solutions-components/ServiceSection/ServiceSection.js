        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="da-sec-titlte text-center mb-30">
              ...
              <h2 className="title">Engineering and BIM solutions to help you build smarter</h2>
              <p className="content">Turn fragmented designs into an integrated model – and unlock the true potential of your projects.</p>
            </div>
          </div>
        </div>
        <div className="da-service-wrapper">
          {Services.slice(10, 14).map((service, index) => (
            ...
            >
              ...
              <Link onClick={ClickHandler} to={`/service/${service.slug}`} className="xb-overlay"></Link>
            </div>
          ))}
